package com.gyx.bitcoinwalletdemo.util;

import android.nfc.Tag;
import android.util.Log;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.gyx.bitcoinwalletdemo.BitCoinTestApplication;
...
public class KeyStoreUtils {
    ...
    public static final String KEYSTORE_PATH = BitCoinTestApplication.getInstance().getFilesDir().getPath() + "/keystore";
